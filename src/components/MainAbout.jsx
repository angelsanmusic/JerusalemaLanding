    ...
    <div className="aspect-video">
            ...
            <div className="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div className="relative space-y-8 py-12 p-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-300">
                    We evaluate surfaces, set quality standards, plan logistics,
                    and secure optimal contracts for efficiency and precision
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-2xl w-f mx-auto text-center">
        ...
        <p className="mt-6 text-lg leading-7 text-black/70 lg:leading-8 lg:text-xl">
          We believe in working with full dedication, strength, and precision.
          Every project is an opportunity to give our best, ensuring quality,
          efficiency, and excellence in everything we do—just as we are
          reminded: ‘Whatever your hand finds to do, do it with all your might.’
          (Ecclesiastes 9:10).
        </p>
        <div className="mt-8">
